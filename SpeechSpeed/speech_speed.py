...
class SpeechSpeedClass:
    ...
    def get_range(self, path=r'C:\Users\halilibrahim.hatun\Documents\Psynexa\Capstone-project\SpeechSpeed\speed_range.yaml'):
    ...
    def calculate_speaking_speed(self, audio_path, text):
        self.logger.info("Speech speed is calculating...")
        ...
        try:
            ...
            self.logger.info("Speed Speech Score saved in class successfully. ")

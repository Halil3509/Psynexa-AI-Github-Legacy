...
class ADHDCalculation:
    def __init__(self):
        self.score = None
        self.label = None  # Result Label
        self._coords = self.get_yaml_file()
        self._range = self.get_yaml_file(r"/home/psynexa/Psynexa/AI/Psynexa-AI-Github/EyeDetection/eye_range.yaml")
    ...
    def get_yaml_file(self,
                      file_path=r'/home/psynexa/Psynexa/AI/Psynexa-AI-Github/EyeDetection/landmarks.yaml'):
        try:
        ...
        with mp_face_mesh.FaceMesh(
            ...
            while True:
                ...
                if results.multi_face_landmarks:
                    ...
                    # Eye segmentation
                    [cv2.circle(frame, mesh_points[p], 1, utils.GREEN, -1, cv2.LINE_AA) for p in
                     self._coords['LEFT_EYE']]
                    [cv2.circle(frame, mesh_points[p], 1, utils.GREEN, - 1, cv2.LINE_AA) for p in
                     self._coords['RIGHT_EYE']]
                    ...
                    cv2.putText(frame, f"Distance: {distance:.2f}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0),
                                2)
                ...
                frame = utils.textWithBackground(frame, f'FPS: {round(fps, 1)}', utils.FONTS, 1.0, (20, 50),
